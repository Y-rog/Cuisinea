...
function saveRecipe(PDO $pdo, int $category, string $title, string $descritpion, string $ingredients, string $instructions, string|null $image)
{
    ...
    $query->bindParam(':description', $descritpion, PDO::PARAM_STR);
